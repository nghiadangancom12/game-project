...
bool InitData()
{
    ...
    g_window = SDL_CreateWindow("Nguyen Do Trong Nghia",
...
int main(int argc, char* argv[])
{
    ...
    bool is_quit = SDLCommonFunc::MainMenu(g_screen);
    while (!is_quit)
    {
        fps_timer.start();
        ...
        for (int i = 0; i < threats_list.size(); i++)
        {
            ...
            if (p_threat != NULL)
            {
                ...
                if (bCol1 || bCol2)
                {
                    ...
                    {
                            g_victory.LoadImg ("img//gameover.png",g_screen);
                            g_victory.Render(g_screen); 
                            SDL_RenderPresent(g_screen);  
                ...
                for (int t = 0; t < threats_list.size(); ++t)
                {
                    ...
                    if (obj_threat != NULL)
                    {
                        ...
                        if (bCol)
                        {
                            ...
                            if (mark_value == 40)
                            {
                                g_victory.LoadImg ("img//youwin.png",g_screen);
                            g_victory.Render(g_screen); 
                            SDL_RenderPresent(g_screen);  
                            SDL_Delay (1000);
